...
const steps = [
  ...
  },
  {
    ...
    title: "カウンセリング（30分）",
    description:
      "40代特有のお悩み、目標をヒアリング。無理な勧誘は一切ありません。",
    icon: <HiChat className="w-6 h-6" />,
  },
  {
    number: 3,
    title: "精密3軸診断",
    description: "姿勢・食事・継続の3軸で、40代のあなたの体を徹底分析。",
  ...
  },
  {
    ...
    title: "プログラム提案",
    description:
      "診断結果に基づき、あなた専用のプランをご提案。じっくりご検討ください。",
    icon: <HiClipboardCheck className="w-6 h-6" />,
  },
];

export default function Over40Flow() {
  return (
