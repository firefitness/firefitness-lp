...
const plans = [
  {
    ...
    isPopular: false,
    features: ["精密3軸診断", "姿勢チェック", "体験トレーニング"],
  },
  {
    name: "スタンダード",
    price: "44,000",
    ...
    description: "姿勢改善に特化したオーダーメイドプログラム",
    isPopular: true,
  ...
  },
  {
    ...
    description: "短期集中で体質改善したい方へ",
    isPopular: false,
    features: ["オーダーメイドプログラム", "食事アドバイス", "LINEサポート", "優先予約"],
  },
];

export default function DeskworkPrice() {
  return (
                ...
                <ul className="space-y-2 mb-6">
                  {plan.features.map((feature, i) => (
                    <li key={i} className="flex items-center gap-2 text-sm">
                      <HiCheck className="w-5 h-5 flex-shrink-0 text-primary" />
                      <span>{feature}</span>
                    </li>
                  ))}
                </ul>
