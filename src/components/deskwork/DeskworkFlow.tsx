...
const steps = [
  ...
  },
  {
    ...
    title: "カウンセリング（30分）",
    description:
      "肩こり・腰痛などの症状、デスクワークの環境をヒアリング。無理な勧誘は一切ありません。",
    icon: <HiChat className="w-6 h-6" />,
  },
  {
    number: 3,
    title: "精密3軸診断",
    description: "姿勢・食事・継続の3軸で、あなたの体の問題点を徹底分析。",
  ...
  },
  {
    ...
    title: "体験トレーニング",
    description:
      "姿勢改善に効果的なメニューを体験。正しいフォームを丁寧に指導します。",
  ...
  },
  {
    ...
    title: "プログラム提案",
    description:
      "診断結果に基づき、あなた専用の改善プランをご提案。じっくりご検討ください。",
    icon: <HiClipboardCheck className="w-6 h-6" />,
  },
];

export default function DeskworkFlow() {
  return (
          ...
          <div className="space-y-8">
            {steps.map((step, index) => (
              ...
              >
                ...
                {/* コンテンツ */}
                <div
                  className={`ml-24 md:ml-0 md:w-[calc(50%-3rem)] bg-light rounded-xl p-6 shadow-sm ${
