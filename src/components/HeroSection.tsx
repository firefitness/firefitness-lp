...
export default function HeroSection({
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-secondary via-secondary to-gray-900 pt-16">
      {/* オーバーレイパターン */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center text-white">
        {/* サブタイトル */}
        <p className="text-primary font-medium text-lg md:text-xl mb-4 animate-fade-in">
          {subtitle}
        </p>
